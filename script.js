    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בורדר מזון וציוד לחיות מחמד משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '66364d0e-7363-42b6-ab6f-31b4fdfc4747',
                    name: data.name || '',
                    email: data.email || '',
